...
const donateCharityRouter = require('./routers/donateCharityRouter');
const donateUserRouter = require('./routers/donateUserRouter');
...
app.use('/api/donates-charity', donateCharityRouter);
app.use('/api/donates-user', donateUserRouter);
